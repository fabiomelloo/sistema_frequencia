            ...
            <form action="{{ route('lancamentos.update', $lancamento) }}" method="POST">
                ...
                <div class="row mb-3" id="dias-container" style="display: none;">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="dias_lancados" id="dias_lancados" class="form-control @error('dias_lancados') is-invalid @enderror" min="0" value="{{ old('dias_lancados', $lancamento->dias_lancados) }}">
                        @error('dias_lancados')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
