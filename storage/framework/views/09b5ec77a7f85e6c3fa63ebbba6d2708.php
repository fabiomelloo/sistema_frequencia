...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3" id="dias-container" style="display: none;">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="dias_lancados" id="dias_lancados" class="form-control <?php $__errorArgs = ['dias_lancados'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" min="0" value="<?php echo e(old('dias_lancados')); ?>">
                        <?php $__errorArgs = ['dias_lancados'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
