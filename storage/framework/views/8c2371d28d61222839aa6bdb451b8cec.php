...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.eventos.store')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               id="codigo_evento" name="codigo_evento" value="<?php echo e(old('codigo_evento')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="descricao" name="descricao" value="<?php echo e(old('descricao')); ?>" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="exige_dias" name="exige_dias" <?php echo e(old('exige_dias') ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="exige_dias">Exige Dias</label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="exige_valor" name="exige_valor" <?php echo e(old('exige_valor') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                               id="valor_minimo" name="valor_minimo" value="<?php echo e(old('valor_minimo')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                               id="valor_maximo" name="valor_maximo" value="<?php echo e(old('valor_maximo')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                               id="dias_maximo" name="dias_maximo" value="<?php echo e(old('dias_maximo')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="exige_observacao" name="exige_observacao" <?php echo e(old('exige_observacao') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/eventos/create.blade.php ENDPATH**/ ?>