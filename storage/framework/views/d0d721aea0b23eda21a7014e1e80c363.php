...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <?php $__currentLoopData = $setores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($setor->id); ?>" <?php echo e(old('setor_id', $user->setor_id) == $setor->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="SETORIAL" <?php echo e(old('role', $user->role) === 'SETORIAL' ? 'selected' : ''); ?>>
                                Setorial (Registra lançamentos)
                            </option>
                            <option value="CENTRAL" <?php echo e(old('role', $user->role) === 'CENTRAL' ? 'selected' : ''); ?>>
