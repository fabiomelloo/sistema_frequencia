...
class SaveOcorrenciaFrequenciaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data_inicio' => ['nullable', 'date_format:Y-m-d', 'required_without:dias_especificos', 'prohibits:dias_especificos'],
            'data_fim' => ['nullable', 'date_format:Y-m-d', 'required_with:data_inicio', 'after_or_equal:data_inicio'],
            'dias_especificos' => ['nullable', 'array', 'prohibits:data_inicio,data_fim'],
    ...
    public function messages(): array
    {
        return [
            ...
            'data_inicio.prohibits' => 'Informe um período ou dias específicos, não ambos.',
            'dias_especificos.prohibits' => 'Informe um período ou dias específicos, não ambos.',
